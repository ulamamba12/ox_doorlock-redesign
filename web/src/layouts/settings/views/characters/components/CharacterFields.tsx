...
const CharacterFields: React.FC = () => {
  ...
  return (
    <>
      <style>
        {`
          .maula-character-input::placeholder {
            color: rgba(255, 224, 168, 0.42);
            font-weight: 700;
            letter-spacing: 0.4px;
          }

          .maula-character-delete:active {
          ...
          >
            <Group position="apart" noWrap spacing={12}>
                  ...
                  <TextInput
                    ...
                    styles={{
                      input: {
                        ...
                        '&:focus': {
                          borderColor: 'rgba(255, 214, 140, 0.70)',
                          boxShadow: `
                            inset 0 1px 0 rgba(255,255,255,0.07),
                            inset 0 -5px 10px rgba(0,0,0,0.30),
                            0 8px 18px rgba(0,0,0,0.26),
                            0 0 18px rgba(255,196,82,0.20)
                          `,
                        },
                      },
                    }}
              ...
              >
                <Box component="span">
                  <ActionIcon
                    className="maula-character-delete"
                    disabled={!canDelete}
                    variant="outline"
